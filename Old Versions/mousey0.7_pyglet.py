...
import random, pygame, pyglet, math, time, sys
from pygame.locals import *

TITLE = 'Mousie! v0.7 PYGLET experimental'
...
def main():
    ...
    #soundObj = pygame.mixer.Sound('scream.mp3')
...
def runGame():
    ...
    timerSound = pygame.mixer.Sound('BeepMedium.wav')
    timerSound2 = pyglet.resource.media('BeepMedium.wav')
    ...
    while True: # The main game loop
        ...
        # Play a sound every 0.5 second
        if currentTime - soundTimer > 0.5:
...
def drawScore(score, distance):
    ...
    distRect.topleft = (WINDOWWIDTH - 120, 20)
